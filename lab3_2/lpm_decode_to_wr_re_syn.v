...
// ============================================================
// File Name: lpm_decode_to_wr_re.v
// Megafunction Name(s):
// 			lpm_decode
//
...
module  lpm_decode_to_wr_re_decode
	( 
	data,
...
endmodule //lpm_decode_to_wr_re_decode
//VALID FILE
...
`timescale 1 ps / 1 ps
// synopsys translate_on
module lpm_decode_to_wr_re (
	data,
	eq1,
	eq2,
	eq3,
	eq4)/* synthesis synthesis_clearbox = 1 */;
	...
	lpm_decode_to_wr_re_decode	lpm_decode_to_wr_re_decode_component (
				.data (data),
				.eq (sub_wire0));
...
// Retrieval info: GEN_FILE: TYPE_NORMAL lpm_decode_to_wr_re.tdf TRUE
// Retrieval info: GEN_FILE: TYPE_NORMAL lpm_decode_to_wr_re.inc TRUE
// Retrieval info: GEN_FILE: TYPE_NORMAL lpm_decode_to_wr_re.cmp FALSE
// Retrieval info: GEN_FILE: TYPE_NORMAL lpm_decode_to_wr_re.bsf TRUE FALSE
// Retrieval info: GEN_FILE: TYPE_NORMAL lpm_decode_to_wr_re_inst.tdf FALSE
// Retrieval info: GEN_FILE: TYPE_NORMAL lpm_decode_to_wr_re_syn.v TRUE
